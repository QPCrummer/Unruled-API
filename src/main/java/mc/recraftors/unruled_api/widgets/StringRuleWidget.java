...
public class StringRuleWidget extends NamedRuleWidget {
    ...
    public StringRuleWidget(Text name, List<OrderedText> description, String ruleName, StringRule rule, EditGameRulesScreen screen) {
        ...
        this.valueWidget.setMaxLength(rule.getMaxLength());
